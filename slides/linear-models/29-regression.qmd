...
```{r sample-correlation-distribution-run, fig.align = "center", echo=FALSE} 
B <- 1000 
N <- 25 
r <- replicate(B, { 
...
```{r small-sample-correlation-not-normal-run, fig.align = "center", echo=FALSE} 
...
```{r diagnostic-plots-run, echo=FALSE} 
#| echo: false 
#| out-width: 100% 
rafalib::mypar(1,3) 
plot(fit, which = 1:3) 
