...
We begin by loading in the data and packages (note that `counts` is a sparse matrix):
...
#data
counts <- readRDS('gene_counts.rds') # gene counts matrix
coords <- readRDS('cell_coords.rds') # cell coords matrix

neuron_cells <- readRDS('neuron_cells.rds') # list of neuron cell barcodes.
other_cells <- readRDS('other_cells.rds') # list of non-neuron cell barcodes.

positive_genes <- readRDS('positive_genes.rds') # list of genes specific for neurons
negative_genes <- readRDS('negative_genes.rds') # list of genes specific for not neurons
other_genes <- readRDS('other_genes.rds') # selected list of other genes
